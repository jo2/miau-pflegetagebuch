...
public class CustomHelpHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput handlerInput) {
        ...
        switch (helpArea) {
            case "general":
            case "allgemeines":
                help = "Dieser Skill ermöglicht dir die Dokumentation von Pflegeaufgaben. Du kannst Pflegeaufgaben erstellen, anzeigen und als erledigt markieren." +
                        "Für Hilfe zum Erstellen von Pflegeaufgaben frage: hilf mir mit Aufgaben erstellen, für Hilfe zum Abschließen von Pflegeaufgaben " +
